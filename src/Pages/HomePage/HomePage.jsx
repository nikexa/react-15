...
const HomePage = () => {
  return (
    <div className="flex flex-col items-center justify-start h-[100vh] text-white bg-center bg-cover mt-[-85px] max-xl:mt-[-120px] bg-repeat " style={{backgroundImage:"url('/rame.png')"}}>
